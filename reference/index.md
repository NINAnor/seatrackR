...
Use the seatrackR shiny interface
...
- [`check_db_version()`](https://ninanor.github.io/seatrackR/reference/check_db_version.md)
...
- [`sampleRingHistory`](https://ninanor.github.io/seatrackR/reference/sampleRingHistory.md)
  : sampleRingHistory
- [`schema_dict`](https://ninanor.github.io/seatrackR/reference/schema_dict.md)
  : schema_dict
